...
import { Loader, Point, interaction, Ticker } from "pixi.js";
import { DragHelper } from "./DragHelper";
export class InverseKinematics extends BaseDemo {
	...
	public constructor() {
		...
		factory.parseDragonBonesData(Loader.shared.resources["dragon/mecha_1406/mecha_1406_ske.json"].data);
		...
		factory.parseDragonBonesData(Loader.shared.resources["dragon/floor_board/floor_board_ske.json"].data);
		factory.parseTextureAtlasData(
			Loader.shared.resources["dragon/floor_board/floor_board_tex.json"].data,
			Loader.shared.resources["dragon/floor_board/floor_board_tex.png"].texture
		);
		//
	...
	destroy(options?: { children?: boolean; texture?: boolean; baseTexture?: boolean }): void {
		...
		DragHelper.getInstance().disableDrag(this._floorBoard.armature.getSlot("circle").display); //technically unneeded, but to be extra safe
