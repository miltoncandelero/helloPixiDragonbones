...
export class MultiTextureAltas extends BaseDemo {
	...
	public constructor() {
		...
		factory.parseDragonBonesData(Loader.shared.resources["dragon/effect/effect_ske.json"].data, "hd", 1.0);
		factory.parseDragonBonesData(Loader.shared.resources["dragon/effect/effect_ske.json"].data, "sd", 0.5);
		factory.parseTextureAtlasData(Loader.shared.resources["dragon/effect/effect_tex.json"].data, Loader.shared.resources["dragon/effect/effect_tex.png"].texture, "hd", 1.0);
		factory.parseTextureAtlasData(
			Loader.shared.resources["dragon/effect/effect_sd_tex.json"].data,
			Loader.shared.resources["dragon/effect/effect_sd_tex.png"].texture,
			"sd",
			2.0
		);
		...
		const touchHandler = (_event: interaction.InteractionEvent) => {
