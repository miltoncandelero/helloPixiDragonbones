...
export class AnimationBase extends BaseDemo {
	...
	public constructor() {
		...
		factory.parseDragonBonesData(Loader.shared.resources["dragon/progress_bar/progress_bar_ske.json"].data);
		factory.parseTextureAtlasData(
			Loader.shared.resources["dragon/progress_bar/progress_bar_tex.json"].data,
			Loader.shared.resources["dragon/progress_bar/progress_bar_tex.png"].texture
		);
		//
